...
module.exports = function(self, options) {
  ...
  self.route("post", "crop", self.middleware.canUpload, function(req, res) {
    ...
    return self.crop(req, _id, crop, function(err) {
      res.send({
        status: err ? (typeof err === "string" ? err : "error") : "ok"
      });
    });
  });

  self.route("post", "crop-editor", self.middleware.canUpload, function(
    req,
    res
  ) {
  ...
  self.route("post", "focal-point-editor", self.middleware.canUpload, function(
    req,
    res
  ) {
