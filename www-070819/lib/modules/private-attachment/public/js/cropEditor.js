apos.define("private-attachment-crop-editor", {
  ...
  construct: function(self, options) {
    ...
    self.afterShow = function() {
      ...
      self.$cropImage.attr(
        "src",
        apos.attachments.url(self.attachment, { size: "original" })
      );
    ...
    self.saveContent = function(callback) {
      ...
      self.api(
        "crop",
        { _id: self.attachment._id, crop: self.attachment.crop },
        function(data) {
          if (data.status !== "ok") {
