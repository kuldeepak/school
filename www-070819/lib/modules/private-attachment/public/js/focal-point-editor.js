apos.define("private-attachment-focal-point-editor", {
  ...
  construct: function(self, options) {
    ...
    self.afterShow = function() {
      ...
      self.croppedWidth =
        (options.crop && options.crop.width) || self.attachment.width;
      self.croppedHeight =
        (options.crop && options.crop.height) || self.attachment.height;
      ...
      self.$focalPointImage.attr(
        "src",
        apos.attachments.url(self.attachment, {
          size: "original",
          crop: options.crop
        })
      );
